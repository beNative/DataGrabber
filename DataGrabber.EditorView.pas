...
uses
  ...
  SynEdit, SynHighlighterSQL, SynCompletionProposal, SynEditHighlighter,
...
procedure TfrmEditorView.FSynCPExecute(Kind: SynCompletionType;
  Sender: TObject; var CurrentInput: UnicodeString; var x, y: Integer;
