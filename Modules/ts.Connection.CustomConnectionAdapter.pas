...
unit ts.Connection.CustomConnectionAdapter;

{ Abstract datamodule intended to host a database connection.
  This datamodule will act as a connection adapter. }
...
type
  TCustomConnectionAdapter = class (TInterfacedObject, IConnection)
  private
...
procedure TCustomConnectionAdapter.AfterConstruction;
begin
...
procedure TCustomConnectionAdapter.BeforeDestruction;
begin
...
procedure TCustomConnectionAdapter.SetConnectionString(const Value: string);
var
  B: Boolean;
begin
...
function TCustomConnectionAdapter.GetConnectionSettings: TConnectionSettings;
begin
  Result := FConnectionSettings;
end;

function TCustomConnectionAdapter.GetProtocols: TStrings;
begin
  Result := FProtocols;
end;
{$ENDREGION}
...
procedure TCustomConnectionAdapter.ConnectionSettingsChanged(Sender: TObject);
begin
